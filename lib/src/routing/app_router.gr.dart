...
import 'package:hcs/features/Home/Driver_Payment/presentation/pages/driver_payment_screen.dart'
    as _i4;
import 'package:hcs/features/Home/Driver_Payment/presentation/pages/order_summary_page.dart'
    as _i14;
...
import 'package:hcs/features/settings/presentation/pages/settings_screen.dart'
    as _i18;
import 'package:hcs/src/enums/service_type.dart' as _i21;

/// generated route for
/// [_i1.AppoinmentScreen]
class AppoinmentRoute extends _i19.PageRouteInfo<AppoinmentRouteArgs> {
  AppoinmentRoute({
    _i20.Key? key,
...
class CustomerRoute extends _i19.PageRouteInfo<CustomerRouteArgs> {
  CustomerRoute({
    _i20.Key? key,
    required _i21.ServiceType serviceType,
    List<_i19.PageRouteInfo>? children,
  }) : super(
         CustomerRoute.name,
...
class CustomerRouteArgs {
  ...
  final _i21.ServiceType serviceType;
...
class DaysSelectionRoute extends _i19.PageRouteInfo<void> {
  const DaysSelectionRoute({List<_i19.PageRouteInfo>? children})
...
class DriverPaymentRoute extends _i19.PageRouteInfo<void> {
  const DriverPaymentRoute({List<_i19.PageRouteInfo>? children})
...
/// generated route for
/// [_i5.EmployeesScreen]
class EmployeesRoute extends _i19.PageRouteInfo<void> {
  const EmployeesRoute({List<_i19.PageRouteInfo>? children})
...
class HomeContentRoute extends _i19.PageRouteInfo<void> {
  const HomeContentRoute({List<_i19.PageRouteInfo>? children})
...
class MyOrdersContentRoute extends _i19.PageRouteInfo<void> {
  const MyOrdersContentRoute({List<_i19.PageRouteInfo>? children})
...
/// generated route for
/// [_i14.OrderSummaryPage]
class OrderSummaryRoute extends _i19.PageRouteInfo<OrderSummaryRouteArgs> {
  OrderSummaryRoute({
    _i20.Key? key,
    required _i22.OrderSummary order,
    List<_i19.PageRouteInfo>? children,
  }) : super(
         OrderSummaryRoute.name,
         args: OrderSummaryRouteArgs(key: key, order: order),
         initialChildren: children,
       );
  ...
  static _i19.PageInfo page = _i19.PageInfo(
    ...
    builder: (data) {
      ...
      return _i14.OrderSummaryPage(key: args.key, order: args.order);
    },
  );
}

class OrderSummaryRouteArgs {
  const OrderSummaryRouteArgs({this.key, required this.order});

  final _i20.Key? key;

  final _i22.OrderSummary order;

  @override
  String toString() {
    return 'OrderSummaryRouteArgs{key: $key, order: $order}';
  }
}
...
/// generated route for
/// [_i16.ServiceConfigurationScreen]
class ServiceConfigurationRoute extends _i19.PageRouteInfo<void> {
  const ServiceConfigurationRoute({List<_i19.PageRouteInfo>? children})
  ...
  static _i19.PageInfo page = _i19.PageInfo(
    name,
    builder: (data) {
      return const _i16.ServiceConfigurationScreen();
    },
  );
}

/// generated route for
/// [_i17.SettingsContentScreen]
class SettingsContentRoute extends _i19.PageRouteInfo<void> {
  const SettingsContentRoute({List<_i19.PageRouteInfo>? children})
  ...
  static _i19.PageInfo page = _i19.PageInfo(
    name,
    builder: (data) {
      return const _i17.SettingsContentScreen();
    },
  );
}
