...
import 'package:hcs/features/settings/presentation/pages/settings_screen.dart'
    as _i16;
import 'package:hcs/src/enums/service_type.dart' as _i19;
...
class CustomerRoute extends _i17.PageRouteInfo<CustomerRouteArgs> {
  CustomerRoute({
    _i18.Key? key,
    required _i19.ServiceType serviceType,
...
class CustomerRouteArgs {
  ...
  final _i19.ServiceType serviceType;
...
class DaysSelectionRoute extends _i17.PageRouteInfo<void> {
  const DaysSelectionRoute({List<_i17.PageRouteInfo>? children})
...
class DriverPaymentRoute extends _i17.PageRouteInfo<void> {
  const DriverPaymentRoute({List<_i17.PageRouteInfo>? children})
...
/// generated route for
/// [_i4.EmployeesScreen]
class EmployeesRoute extends _i17.PageRouteInfo<void> {
  const EmployeesRoute({List<_i17.PageRouteInfo>? children})
...
class HomeContentRoute extends _i17.PageRouteInfo<void> {
  const HomeContentRoute({List<_i17.PageRouteInfo>? children})
...
class MyOrdersContentRoute extends _i17.PageRouteInfo<void> {
  const MyOrdersContentRoute({List<_i17.PageRouteInfo>? children})
...
class ReportRoute extends _i17.PageRouteInfo<void> {
  ...
  static _i17.PageInfo page = _i17.PageInfo(
    name,
    builder: (data) {
      return const _i13.ReportScreen();
    },
  );
}

/// generated route for
/// [_i14.ServiceConfigurationScreen]
class ServiceConfigurationRoute extends _i17.PageRouteInfo<void> {
  const ServiceConfigurationRoute({List<_i17.PageRouteInfo>? children})
  ...
  static _i17.PageInfo page = _i17.PageInfo(
    name,
    builder: (data) {
      return const _i14.ServiceConfigurationScreen();
    },
  );
}

/// generated route for
/// [_i15.SettingsContentScreen]
class SettingsContentRoute extends _i17.PageRouteInfo<void> {
  const SettingsContentRoute({List<_i17.PageRouteInfo>? children})
  ...
  static _i17.PageInfo page = _i17.PageInfo(
    name,
    builder: (data) {
      return const _i15.SettingsContentScreen();
    },
  );
}
